...
- [X] Пропишите requests/limits и напишите зачем это нужно в описание PR
      ...
      **минимальные и максимальные требования по вычислительным ресурсам**
...
- [X] Модифицируйте свое приложение так, чтобы оно стартовало не сразу(с
      ...
      описании -- чего вы этим добились. **под не поднимается, пока не будет
      готов сервис, а случае его падения под перезапускается**
